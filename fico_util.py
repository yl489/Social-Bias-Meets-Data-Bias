#####################################################################################
# Code adopted from: https://github.com/lydiatliu/delayedimpact/blob/master/fico.py #
#####################################################################################
...
def read_totals(data_dir=DATA_DIR):
    ...
    return {r: frame.loc[0, r] for r in frame.columns}
